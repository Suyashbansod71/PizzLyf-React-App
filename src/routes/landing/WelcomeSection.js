    ...
    <article className="welcome-section" >
      <section className="section-2-info flex-container flex-column txt-center pop-font">
        ...
        <h2 className="txt-white">
          Welcome to <span>PizzLyf</span> restaurant
        </h2>
        <p>
          Founded in 2023 we bring pizza slice by slice to the next level!
          ...
          options for corporate parties! At PizzLyf we care about you
